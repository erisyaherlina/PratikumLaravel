                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahBerita') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tanggalTerbit" required value="{{ old('tanggalTerbit') }}">
                                <span class="text-danger">
                                    @error('tanggalTerbit')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="konten" placeholder="Tulis deskripsi buku disini...." style="height: 250px" required value="{{ old('konten') }}"></textarea>
                            </div>
