...
<body>
    ...
    <div class="content">
            ...
            <div class="col-6">
                <form action="{{ route('admin.aktivitas') }}" method="GET">
                    ...
                    <div class="input-group">
                        <input type="search" name="search" class="form-control rounded" placeholder="Cari judul aktivitas" aria-label="Search" aria-describedby="search-addon" />
        ...
        <div class="row mt-5">
            ...
            <div class="col"></div>
            <div class="col-2">
                <a class="btn btn-success" href="{{route('admin.tambahAktivitas') }}" style="text-decoration: none; margin-left: 30px">Tambah Data +</a>
            </div>
        </div>
