...
<body>
    ...
    <section id="home" class="text-center py-5">
        <img src="{{ ('img/ica.jpg') }}" width="100" alt="Your Name" class="rounded-circle">

        <h1>Erisya Herlina</h1>
        <hr class="mx-4">
        <h3>About Me</h3>
        <p>Jangan Mati Sebelum ke IceBlue</p>
    </section>
    <section id="cv" class="container pb-5">
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>Saya bisa melihat Kucing</td>
                        <td>Member Agence</td>
                    </tr>
                    <tr>
                        <td>Melihat yang bisa Makan</td>
                        <td>Eyecare</td>
                    </tr>
